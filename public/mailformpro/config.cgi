...
$config{"ReturnSubject"} = '[ %s ] お問い合せありがとうございます';
...
WEBサイトからの無料相談もしくはお問い合わせを受付いたしました。

2～3営業日以内に担当者より、ご連絡させていただきます。
万が一、3営業日を過ぎても連絡が無い場合は、不達の可能性がございますので、
大変お手数ではございますが、下記の電話番号までご連絡をお願いいたします。
